...
| 21.26 | Exact inclusion-minimal intersection profiles, union bound, then enumeration of Sylow choices if necessary. | Completed through order 1791 together with known two-prime theory; final range through 2000 running. Direct validation on 211 groups passed. |
