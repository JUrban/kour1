...
Explore1118Matrices:=function()
    local l,t,x,y,w,n,pols,p,g,e,all,a,b,Step,i,j,pair,pairs,G,k,z,seen,Inv;
    Inv:=m->[[m[2][2],-m[1][2]],[-m[2][1],m[1][1]]];
    ...
    for pair in pairs do
        ...
        for i in [1..2] do
            ...
            repeat
                ...
                if z in seen then
                    Print("SOURCE_PAIR_NOT_PERIODIC direction=",i,
                          " repeated_at=",Position(seen,z)," step=",k,"\n");
                    k:=-k; break;
                fi;
                Add(seen,z);
            until k>=100000;
