...
CASES = [(6, 1), (8, 3), (12, 3), (16, 6), (24, 3), (32, 2)]
CAP = 4096
TIMEOUT = 180
...
def main():
    ...
    for n, ident in CASES:
        stem = ROOT / f'results/6.47-pilot-{n}-{ident}'
    ...
    summary = {'status': 'PASS_BOUNDED_PILOT', 'cap': CAP, 'cases': records,
               'scope': 'Associativity and elementary controls only; no variety nonmembership claimed.'}
    (ROOT/'results/6.47-pilot-summary.json').write_text(json.dumps(summary, indent=2)+'\n')
    print('PASS_647_PILOT', flush=True)
