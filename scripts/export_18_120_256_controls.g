...
cases := [[256,503],[256,6547]];
out := OutputTextFile("results/18.120-256-control-inputs.json",false);SetPrintFormattingStatus(out,false);
...
od;
PrintTo(out,"]\n");CloseStream(out);Print("PASS_18120_256_EXPORT\n");
end;;
Export18120();;QUIT;
