...
def run():
    ...
    # Alt(2) is trivial, of order 2!/2=1. The GAP loop consequently
    # tests no prime there. This is the sole permitted rowless entry.
    assert unrepresented == {'Alt(2)'}, unrepresented
    by_name['Alt(2)'] = {'order':1,'primes':[]}
