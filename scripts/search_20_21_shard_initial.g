...
local n,i,G,ab,ns,k,q,cs,as,pair,tested,eligible,both,iso,idsC,idsA,out,hits;
n:=SearchOrder2021;
...
for i in [SearchIndex2021+1,SearchIndex2021+1+SearchShards2021..NumberSmallGroups(n)] do
