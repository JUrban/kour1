...
Updated: 2026-09-11T22:13:36.543949+00:00.
...
- **6.47 partial:** A self-contained proof covers all class-two groups. A 52-file pilot packet replays 289 binary word functions and 522,952 associativity triples, settling the word-operation question for five specific finite groups; one group exceeds the enumeration cap. The 158-file extension packet now certifies all 88 associative outputs in 21 more groups; 12 timed-out cases remain incomplete. In total 26 groups, 911 normalized operations and 19,449,882 triples are covered. Cooper1974 and Płonka2013 are explicit prior sources; no new count. See `research/6.47-class-two.md`, `research/6.47-pilot-report.md`, and `research/6.47-extension-report.md`.
