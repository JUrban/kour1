...
Updated: 2026-09-12T03:57:20.412630+00:00.
...
- **20.21 extension running:** the audited prior Conder--Maslova reduction and pilot exclude all orders below768. Eight1GiB GAP workers now search all1,090,235 groups of order768 using the audited nilpotency filter; the corrected two-shard control exactly reproduces order96. Initial range failure retained. See `research/20.21-minimality-reduction.md` and `research/20.21-extension-plan.md`.
...
- **20.100 n=7 verifying:** generation completed42,891,332 nodes and786,577,344 edges with exit0. Full gzip integrity passes; six GAP workers started11:12 UTC with14GiB workspace ceilings each. At 01:22:17 UTC on 12 September all six are verified live, with 25,760,000 nodes checked, zero completed shards and 36,067,572 KiB combined RSS. No n=7 proof is claimed until every shard and aggregate pass.
