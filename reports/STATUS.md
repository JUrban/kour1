...
Updated: 2026-09-12T11:17:45.887042+00:00.
...
- **20.112 independent finite certificates:** all twelve cases retained by the original8,339-group screen, plus three quotient models, have direct permutation certificates for membership in w*N^3. The28-file replay checks30 Sylow-normalizer chains,61 maximal steps,25,380,864 multiplication entries and five rejected corruptions. General saturation remains unresolved; no new count. See `research/20.112-chain-report.md`.
- **21.98 partial and17.115 source audit:** a rational polynomial path proves the finite-by-cyclic conclusion for every word in every locally finite-by-nilpotent group, with cyclic verbal subgroup in the torsion-free locally nilpotent case. The general FC reduction is prior Cutolo--Nicotera2010 Lemma1.1. Poss1975 proves only special locally free cases of17.115. The35-file replay passes48 paths,384 exact evaluations and native GAP polynomial agreement. Both full questions remain unresolved; see `research/21.98-nilpotent-case.md`, `research/21.98-followup-report.md` and `research/17.115-source-audit.md`.
- **17.118 partial:** optimal characteristic exponent-p index bounds are 4 for p=2 and 27 for p=3. An explicit finite squarefree-word algebra group requires index exactly p^p for every prime. If the given index-p subgroup has class c, the upper bound p^(c+1) holds and is sharp at c=p-1. General p>=5 remains unresolved. The 35-file replay passes, including all 6,561 element witnesses, 19,683 generator edges, five rejected corruptions and a faithful GAP matrix isomorphism. No new count; see `research/17.118-partial-proof.md` and `research/17.118-report.md`.
- **Three prior answers audited:** PF:2026.000002 gives the full affirmative answer to **17.113**, with28 GAP cases and507,074 independent coordinate projection checks. PF:2026.000005 proves **19.1 for all knot groups**, removing the earlier knot-convention scope limit. PF:2026.000006 explicitly gives both prior **19.9** answers; the audit supplies the uniform Deligne obstruction and finite-generation step. The52-file evidence audit passes. No increase from44 new candidates; see `research/proofforum-2-5-6-audit-report.md`.
- **19.48 prior negative answer, independent alternative retained:** ProofForum PF:2026.000007 v1 was uploaded on September 1 and gives a cubic characteristic-zero example. Its complete two-page proof and exact integer identities were checked. Our separate quadratic characteristic-three example over F9(t)/F3(t) has every level free of rank two over F3[t]; an explicit nine-factor word proves nonclosedness. The 33-file replay passes, including 3,024 module-basis products. This adds no new candidate. See `research/19.48-proof.md` and `research/19.48-source-audit.md`.
...
- **20.100 n=7 verifying:** generation completed42,891,332 nodes and786,577,344 edges. At 2026-09-12T10:09:36.749305+00:00, all six14 GiB GAP workers are live, with 40,880,000 checked nodes, zero completed shards, and 57,409,780 KiB combined RSS. No n=7 proof is claimed until every shard and aggregate pass.
