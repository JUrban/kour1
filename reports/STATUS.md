...
Updated: 2026-09-11T12:46:39.767646+00:00.
...
- Latest prior-result audit: the SO(3,R) case of 16.68 and 16.69(b) are negative by Thom's almost-law theorem. Exact norm and quaternion-scaling deductions are retained in `research/16.68-16.69-prior-results.md`, excluded from the new count. Earlier audit: 14.59 is negative by Tent2016; the exact countable-action deduction is retained. Earlier published consequences for 5.15, 12.11, 13.39(f), and14.15 remain excluded from new priority.
