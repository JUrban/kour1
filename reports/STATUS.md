...
- **19.61 G2(Z/9):** all 20,047 carpets are already closed. Exact congruence kernels cover 109,693 reduced matrix states; 219 direct Python group controls agree. The complete replay audit passes. General question unresolved; see `research/19.61-g2-z9-report.md`.

- **19.61 G2(F9):** all 40,105 carpets have carpet closures; 4,032 enlarge. Independent full-matrix controls verify 1,114 cases, including 99 enlargements. The 62-file packet audit passes. General question unresolved; see `research/19.61-g2-f9-report.md`.

- **19.61 G2 four-ring extension:** all 135,700 carpets have carpet closures; 12,492 enlarge. Independent matrix controls verify 2,214 cases and all faithful-action witnesses. The 38-file packet audit passes. General question unresolved; see `research/19.61-g2-rings-report.md`.

- **19.61 G2 pilot:** all 391 valid carpets over F2 and F3 are already closed. Independent matrices verify 390 cases; the full F3 assignment is immediate. The 26-file audit reproduces both inputs and all controls. General question unresolved; see `research/19.61-g2-report.md`.

- **19.61 C2 pilot:** all17,609 carpets over F2,F4,F2[t]/(t^2),F2 x F2,Z/4 have carpet closures;3,048 enlarge. Independent matrix enumeration checks1,288 cases, including104 enlargements. The36-file auditor passes after a retained JSON-key comparison failure. General question unresolved; see `research/19.61-c2-report.md`.
...
2. Continue novelty and mathematical audits of all forty-two candidate resolutions.
