...
Updated: 2026-09-11T00:29:35.647930+00:00.

- Active phase: proof audit, exact searches, and broader problem triage.
- Complete candidate resolutions: **7**: **21.106** (negative), **21.132** (construction for every prime), **21.121(a)** (infimum not attained at p=2), **21.68** (semi-abelian non-monomial group of order2592), **16.87(a),(b)** (nonabelian, nonperiodic variety with maximal test rank at every finite rank), **10.35** (torsion-free complex matrix group not residually rational in the same degree), and **16.28(a)** (a closed set with every power greater than one nonclosed). All await outside review and further novelty checks.
- Externally reviewed new solutions: 0.
- Both the 21.26 search through order2000 and the 19.20 search through order255 are complete. The 19.20 order256 extension is running in 16 GAP workers; all process command lines and logs were just revalidated. At this snapshot 20,555 groups have been counted, with 0 equality hits and 62 reverse inequalities.
...
kept separate from the seven candidate resolutions.
...
2. Continue novelty and mathematical audits of all seven candidate resolutions.
