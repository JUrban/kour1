...
Updated: 2026-09-12T03:24:20.451366+00:00.
...
- **20.21 extension running:** the audited prior Conder--Maslova reduction and pilot exclude all orders below768. Eight1GiB GAP workers now search all1,090,235 groups of order768; the corrected two-shard control exactly reproduces order96. Initial range failure retained. See `research/20.21-minimality-reduction.md` and `research/20.21-extension-plan.md`.
