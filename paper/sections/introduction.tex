...
Related approaches include learned tactical proof search in
TacticToe~\cite{tactictoe-2017}, program-library and search-policy
learning in DreamCoder~\cite{dreamcoder}, and iterative program
synthesis and neural training in Alien Coding~\cite{alien-coding}.
Later examples include AlphaProof's formal reinforcement-learning
results~\cite{alphaproof} and FunSearch's language-model-guided
program search~\cite{funsearch}. First Proof studies research-level
mathematical problems with explicit assessment of proposed
solutions~\cite{firstproof,firstproof2}. These settings differ in their
targets, training, evaluators and access to prior results; their
reported outcomes are not directly comparable to the present run.
