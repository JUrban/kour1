...
\caption{Two observable aspects of the frozen trajectory.
The upper panel counts the 198 commits within the research window;
the closeout commit 16 seconds later is excluded.
The lower panel retrospectively follows the first committed principal
...
Both panels are derived from the committed CSV measurements.}
