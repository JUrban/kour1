...
\paragraph{Version 2 attribution update.}
The eleven overlaps with further contemporary papers examined in
Appendix~\ref{app:contemporary-comparison} concern our deadline portfolio.
They are additional to the Fable comparison above. The figure 46 in
this appendix retains its historical meaning; it is not a count of new
solutions to compare with Fable's five answer entries. The checks and
assessments above remain those of the 17 September comparison.
Version~3 withdraws the 10.35 claim from our portfolio, leaving 45
other candidates; see Appendix~\ref{app:statement-correction}.
