\section{Configuration, records and accounting}
\label{app:methods}
...
checkers, and conducted the internal reviews. Within that research phase, \emph{independent implementation} means a
separate representation or algorithm written by the same agent. The later
independent review by Claude Opus[1m] is a separate phase, described in
